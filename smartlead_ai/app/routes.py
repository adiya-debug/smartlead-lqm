...
def sohbet():
    ...
    try:
        ...
        return jsonify({'basari': False, 'hata': 'Asistanımız şu an çok yoğun, lütfen birazdan tekrar deneyin.'}), 503
...
def lead_ekle():
    ...
    return jsonify({'basari': True, 'mesaj': 'Kayıt başarıyla alındı'}), 201
